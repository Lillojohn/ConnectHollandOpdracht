...
class CsvToConsoleCommand extends Command
{
    protected static $defaultName = 'app:csv-to-console';
    private const EXAMPLE_CSV = 'voorbeeld.csv';
    ...
    {
        $this->setDescription('Display content of csv to console');
        $this
